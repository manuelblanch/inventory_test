        ...
        <div class="col-md-8 col-md-offset-2">
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    <form class="form-horizontal" role="form" method="POST" action="{{ route('brand.update', ['id' => $brand->id]) }}">
                       ...
                       <div class="form-group{{ $errors->has('date_entrance') ? ' has-error' : '' }}">
                          ...
                          <div class="col-md-6">
                              <input id="date_entrance" type="text" class="form-control" name="date_entrance" value="{{ $brand->date_entrance }}" required>
                      ...
                      <div class="form-group{{ $errors->has('last_update') ? ' has-error' : '' }}">
                         ...
                         <div class="col-md-6">
                             <input id="last_update" type="text" class="form-control" name="last_update" value="{{ $brand->last_update }}" required>
