        ...
        <div class="col-md-8 col-md-offset-2">
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    <form class="form-horizontal" role="form" method="POST" onsubmit = "return confirm('Estas segur?')" action="{{ route('provider.update', ['id' => $provider->id]) }}">
                        ...
                        <div class="form-group{{ $errors->has('name') ? ' has-error' : '' }}">
                         ...
                         <div class="form-group{{ $errors->has('shortName') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                <input id="shortName" type="text" class="form-control" name="shortName" value="{{ $provider->shortName }}" required>
                       ...
                       <div class="form-group{{ $errors->has('date_entrance') ? ' has-error' : '' }}">
                          ...
                          <div class="col-md-6">
                              <input id="dateEntrance" type="text" class="form-control" name="date_entrance" value="{{ $provider->date_entrance }}" required>
                      ...
                      <div class="form-group{{ $errors->has('last_update') ? ' has-error' : '' }}">
                         ...
                         <div class="col-md-6">
                             <input id="lastUpdate" type="text" class="form-control" name="last_update" value="{{ $provider->last_update }}" required>
